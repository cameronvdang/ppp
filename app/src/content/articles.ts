...
export const ARTICLES: Article[] = [
  {
    ...
    body: [
      ...
      'Knowing which phase you are in explains a lot, and logging is how PPP learns your version of it, not the textbook one.',
    ],
  },
  {
    ...
    body: [
      ...
      'That is why PPP shows an uncertainty band around predictions and never pretends to day-perfect accuracy; anyone who does is guessing with confidence.',
  ...
  },
  {
    ...
    body: [
      ...
      'Heat genuinely helps: a heating pad or warm bath relaxes the muscle. Light movement, such as a walk or stretching, often does more than staying still.',
      ...
      'Log your cramps in PPP: seeing that they arrive, say, the day before flow starts turns dread into a plan.',
  ...
  },
  {
    ...
    body: [
      ...
      'PPP combines what you log: with test results and temperatures, the estimate anchors to your body instead of the calendar.',
      'Estimates are estimates. Do not use any app, including this one, as contraception. If avoiding pregnancy matters to you, use a method designed for it.',
    ],
  },
  {
    slug: 'bbt-how-to',
    ...
    body: [
      ...
      'Log it in PPP and the chart draws itself; look for the sustained shift, not any single reading. Alcohol, illness, and short sleep all nudge the numbers.',
    ],
  },
  {
    slug: 'peri-what-is',
    ...
    body: [
      ...
      'Hot flashes, night sweats, sleep trouble, mood swings, and brain fog are common symptoms. They are real, physiological, and worth tracking; patterns you can show a clinician get taken more seriously than vibes.',
      'PPP’s perimenopause mode scores how often transition-associated symptoms appear in your logs and watches cycle variability for you.',
  ...
  },
  {
    ...
    body: [
      ...
      'PPP tracks your week and due date on-device. The app does not replace prenatal care.',
    ],
  },
  {
    slug: 'why-local',
    ...
    body: [
      ...
      'PPP’s default is architectural: your logs live in your phone’s app storage. Core tracking needs no account and no PPP-hosted user database.',
